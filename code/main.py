...
from UI import home_screen, choose_player, control_scene, game_over, pause_menu, level_menu, end_scene
...
class Game:
	def __init__(self):
		...
		self.control_scene = control_scene.Screen(screen)
	...
	def run(self):
		...
		elif state == "controls": self.control_scene.run()
